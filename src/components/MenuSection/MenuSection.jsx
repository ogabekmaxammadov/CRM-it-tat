      ...
      <div className={`menu-section ${collapsed ? 'collapsed' : ''}`}>
        ...
        <nav>
          <ul>
            ...
            <NavLink to="/teachers" className={({ isActive }) => (isActive ? 'isActive' : '')}>
              <LiaChalkboardTeacherSolid className="nav-icon" />
              <h2>O'qituvchilar</h2>
            </NavLink>

            <NavLink to="/groups" className={({ isActive }) => (isActive ? 'isActive' : '')}>
              <FaLayerGroup className="nav-icon" />
              <h2>Guruxlar</h2>
            </NavLink>

            <NavLink to="/students" className={({ isActive }) => (isActive ? 'isActive' : '')}>
